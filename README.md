...
<img width="1918" height="998" alt="Screenshot 2026-08-02 at 10 40 21" src="https://github.com/user-attachments/assets/aaf8f93a-03e7-49af-88dd-881c1d4a32c2" />
...
| --- | --- | --- |
| **Windows** | [`BombStats-Setup-0.10.14.exe`](https://github.com/lucasvieceli/bombstats-releases/releases/download/v0.10.14/BombStats-Setup-0.10.14.exe) | Instalador (NSIS) |
| **macOS (Apple Silicon — M1/M2/M3)** | [`BombStats-0.10.14-arm64.dmg`](https://github.com/lucasvieceli/bombstats-releases/releases/download/v0.10.14/BombStats-0.10.14-arm64.dmg) | Macs novos |
| **macOS (Intel)** | [`BombStats-0.10.14.dmg`](https://github.com/lucasvieceli/bombstats-releases/releases/download/v0.10.14/BombStats-0.10.14.dmg) | Macs antigos |
| **Linux** | [`BombStats-0.10.14.AppImage`](https://github.com/lucasvieceli/bombstats-releases/releases/download/v0.10.14/BombStats-0.10.14.AppImage) | Roda em qualquer distro |
| **Linux (Debian/Ubuntu)** | [`bombstats_0.10.14_amd64.deb`](https://github.com/lucasvieceli/bombstats-releases/releases/download/v0.10.14/bombstats_0.10.14_amd64.deb) | `sudo dpkg -i …` |
| **Servidor/VPS (Linux x64)** | [`bombstats-server-linux-x64`](https://github.com/lucasvieceli/bombstats-releases/releases/download/v0.10.14/bombstats-server-linux-x64) | Terminal, sem tela — painel no navegador |
| **Servidor/VPS (Linux ARM64)** | [`bombstats-server-linux-arm64`](https://github.com/lucasvieceli/bombstats-releases/releases/download/v0.10.14/bombstats-server-linux-arm64) | Terminal, sem tela — painel no navegador |
