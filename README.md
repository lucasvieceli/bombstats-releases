...
| --- | --- | --- |
| **Windows** | [`BombStats-Setup-0.18.20.exe`](https://github.com/lucasvieceli/bombstats-releases/releases/download/v0.18.20/BombStats-Setup-0.18.20.exe) | Instalador (NSIS) |
| **macOS (Apple Silicon — M1/M2/M3)** | [`BombStats-0.18.20-arm64.dmg`](https://github.com/lucasvieceli/bombstats-releases/releases/download/v0.18.20/BombStats-0.18.20-arm64.dmg) | Macs novos |
| **macOS (Intel)** | [`BombStats-0.18.20.dmg`](https://github.com/lucasvieceli/bombstats-releases/releases/download/v0.18.20/BombStats-0.18.20.dmg) | Macs antigos |
| **Linux** | [`BombStats-0.18.20.AppImage`](https://github.com/lucasvieceli/bombstats-releases/releases/download/v0.18.20/BombStats-0.18.20.AppImage) | Roda em qualquer distro |
| **Linux (Debian/Ubuntu)** | [`bombstats_0.18.20_amd64.deb`](https://github.com/lucasvieceli/bombstats-releases/releases/download/v0.18.20/bombstats_0.18.20_amd64.deb) | `sudo dpkg -i …` |
| **Servidor/VPS (Linux x64)** | [`bombstats-server-linux-x64`](https://github.com/lucasvieceli/bombstats-releases/releases/download/v0.18.20/bombstats-server-linux-x64) | Terminal, sem tela — painel no navegador |
| **Servidor/VPS (Linux ARM64)** | [`bombstats-server-linux-arm64`](https://github.com/lucasvieceli/bombstats-releases/releases/download/v0.18.20/bombstats-server-linux-arm64) | Terminal, sem tela — painel no navegador |
